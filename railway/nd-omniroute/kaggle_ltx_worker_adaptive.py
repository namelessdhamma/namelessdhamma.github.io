...
def main() -> None:
    ...
    if n_gpus > 1:
        max_transformer = {gpu_gen: "14GiB", gpu_hold: "1GiB", "cpu": "8GiB"}
        max_t5 = {gpu_gen: "1GiB", gpu_hold: "14GiB", "cpu": "8GiB"}
    else:
        max_transformer = {0: "14GiB", "cpu": "8GiB"}
        max_t5 = {0: "14GiB", "cpu": "8GiB"}
    print("ND_LTX_GPU_LAYOUT=" + json.dumps({
        "gpu_count": n_gpus,
        "gpu_gen": gpu_gen,
        "gpu_hold": gpu_hold,
    ...
    kwargs = dict(
        ...
        generator=torch.Generator(device=f"cuda:{gpu_gen}").manual_seed(seed),
        output_type="latent",
    ...
    receipt = {
        "ok": True,
        "route": "kaggle_ltx13b_mounted_cache_f2l_adaptive",
