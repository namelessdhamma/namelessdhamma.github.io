...
print('ND_BROWSERLESS_FRONT_PROXY_START '+json.dumps({'port':PORT,'inner_port':INNER_PORT,'relay_path_configured':bool(RELAY_TOKEN),'bootstrap_path_configured':bool(RELAY_TOKEN),'browserless_configured':bool(BROWSERLESS_TOKEN)}),flush=True)
