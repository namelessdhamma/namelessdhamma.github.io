...
V18_LOADER=os.environ.get('ND_VK_V18_ORIGINAL_LOADER','')

if not V18_LOADER:
    raise RuntimeError('ND_VK_V18_ORIGINAL_LOADER missing')
if not DRIVE_SOURCE:
...
print('ND_QSTASH_V18_FULL_DRIVE_FRONT_V2_READY '+json.dumps({'port':PORT,'vk_port':VK_PORT,'drive_port':DRIVE_PORT}),flush=True)
