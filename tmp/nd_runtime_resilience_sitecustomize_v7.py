...
_NEW_V16D = "https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/88a6b8655b0a6b9bb2b04c9bb542fb4504a1f7f1/tmp/nd_vk_gateway_v16d_resilience_memory.py"

_original_urlopen = urllib.request.urlopen
_original_urlretrieve = urllib.request.urlretrieve
def _swap_url(value):
    if isinstance(value, str):
        if value == _OLD_LINEAR: return _NEW_LINEAR
        if value == _OLD_V15B: return _NEW_V16D
    return value
def _urlopen(value,*args,**kwargs): return _original_urlopen(_swap_url(value),*args,**kwargs)
def _urlretrieve(value,*args,**kwargs): return _original_urlretrieve(_swap_url(value),*args,**kwargs)
urllib.request.urlopen=_urlopen
urllib.request.urlretrieve=_urlretrieve
print("ND_RUNTIME_RESILIENCE_SHIM_V7_ACTIVE",flush=True)
