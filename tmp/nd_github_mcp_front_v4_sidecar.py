...
PORT=int(os.environ.get('ND_GITHUB_PROXY_PORT','3100'))
INNER_PORT=int(os.environ.get('PORT','3000'))
...
print('ND_GITHUB_MCP_FRONT_V4_SIDECAR '+json.dumps({'port':PORT,'inner_port':INNER_PORT,'configured':bool(GITHUB_PAT and PATH_TOKEN),'owner':OWNER,'inline_only':True,'attachments':False}),flush=True)
