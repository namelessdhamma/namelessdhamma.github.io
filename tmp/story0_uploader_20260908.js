...
const b=Buffer.from((await (await fetch('https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/354e2f4893bfc820139242dbe3c38fe5580e9f52/tmp/story0_20260908.b64')).text()).trim(),'base64');
...
})().catch(e=>{console.error('NDZEROERR '+e.stack);process.exit(1)});
