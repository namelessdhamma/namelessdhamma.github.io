...
UPSTREAM='https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/6c051774bffff04055a9479d7b95178f5fd9fb60/tmp/nd_gateway_linear_bridge_v2b_father_profile.py'
inner_path='/tmp/nd_existing_gateway.py'
urllib.request.urlretrieve(UPSTREAM,inner_path)
env=dict(os.environ)
env['PORT']=str(INNER_PORT)
env['ND_INNER_GATEWAY_PORT']=str(INNER_PORT+1)
env['ND_DRIVE_BRIDGE_PORT']=str(INNER_PORT+2)
