...
new="new=\"UPSTREAM='https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/787fb1ad148be781946c39f636af770239fbe48c/tmp/nd_meta_pass2_inner_wrapper_v02.py'\""
if src.count(old)!=1:
    raise RuntimeError('pass2 front v3 upstream marker not found exactly once')
src=src.replace(old,new,1)
print('ND_META_PASS2_FRONT_V3_READY',flush=True)
exec(compile(src,'nd_meta_pass2_front_v03_runtime.py','exec'))
