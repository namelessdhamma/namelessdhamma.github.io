...
new='https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/f0753632bf1286406c7684b99596a87507632e21/tmp/nd_meta_graph_full_helper_v01.py'
if src.count(old)!=1:
    raise RuntimeError('meta graph full helper anchor mismatch')
src=src.replace(old,new,1)
print('ND_META_GRAPH_FULL_OUTER_READY',flush=True)
exec(compile(src,'nd_meta_graph_full_inner_v01.py','exec'))
