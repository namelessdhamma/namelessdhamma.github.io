...
code=code.replace("ND_VK_GATEWAY_V13_ND_READONLY_START","ND_VK_GATEWAY_V29_ND_GOOGLE_PROXY_START",1)
'''
outer=outer.replace(marker,marker+"\n"+extra,1)
outer=outer.replace("ND_VK_GATEWAY_V23_ND_READONLY_RANKED_START","ND_VK_GATEWAY_V29_ND_GOOGLE_PROXY_RANKED_START",1)
outer=outer.replace("ND_V23_BOOTSTRAP","ND_V29_BOOTSTRAP",1)
outer=outer.replace("ND_V23_OUTER","ND_V29_OUTER",1)
outer=outer.replace("nd_vk_gateway_v23_outer.py","nd_vk_gateway_v29_outer.py",1)
print('ND_V29_WRAPPER_READY',flush=True)
exec(compile(outer,'nd_vk_gateway_v29_loader.py','exec'))
