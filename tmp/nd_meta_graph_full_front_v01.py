...
new='https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/265208ec1eb0b32e4bfd2f49f6c44b542e279bab/tmp/nd_meta_graph_full_inner_v01.py'
if src.count(old)!=1:
    raise RuntimeError('meta graph full inner anchor mismatch')
src=src.replace(old,new,1)
print('ND_META_GRAPH_FULL_FRONT_READY',flush=True)
exec(compile(src,'nd_meta_graph_full_front_v01.py','exec'))
