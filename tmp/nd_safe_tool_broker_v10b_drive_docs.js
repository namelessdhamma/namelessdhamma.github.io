...
if(!outer.includes(finalizer))throw new Error('v10b finalizer marker missing');

const patchLogic=`
const ddInvoke='async function invokeTool(name,q,args={}){';
if(!patched.includes(ddInvoke))throw new Error('v10b runtime invoke marker missing');
...
if(!patched.includes(ddCat))throw new Error('v10b runtime catalog marker missing');
...
if(!patched.includes(ddServe))throw new Error('v10b runtime serve marker missing');
