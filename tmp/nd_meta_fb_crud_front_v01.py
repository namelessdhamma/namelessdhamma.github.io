...
new="new=\"UPSTREAM='https://raw.githubusercontent.com/namelessdhamma/namelessdhamma.github.io/f23b744247412f144d9f90cadf2a3665cbc853fe/tmp/nd_meta_fb_crud_inner_v01.py'\""
if src.count(old)!=1:
    raise RuntimeError('fb CRUD front upstream marker not found exactly once')
