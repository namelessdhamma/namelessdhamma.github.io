...
'''
print("ND_V20_1_STRONG_PRIMARY_RESERVE_DELTA_APPLIED",flush=True)
rr=P.get("_new_rr","")
...
final=final.replace("ND_VK_GATEWAY_V15B_FATHER_MIN_PROFILE_START","ND_VK_GATEWAY_V20_1_STRONG_PRIMARY_RESERVE_START",1)
if "adaptive_startup_probe" not in final: raise RuntimeError("v18_final_assembly_failed")
print("ND_V20_1_STRONG_PRIMARY_RESERVE_ASSEMBLY_READY",flush=True)
re(rc(final,"nd_vk_gateway_v20_1_strong_primary_reserve_runtime.py","exec"),{"__name__":"__main__"})
